...
$ wget "https://raw.githubusercontent.com/PINTO0309/TensorflowLite-bin/main/2.9.0-rc0/download_tflite_runtime-2.9.0rc0-cp37-none-linux_armv7l.whl.sh"
$ chmod +x download_tflite_runtime-2.9.0rc0-cp37-none-linux_armv7l.whl.sh
$ ./download_tflite_runtime-2.9.0rc0-cp37-none-linux_armv7l.whl.sh
...
$ sudo apt install swig libjpeg-dev zlib1g-dev python3-dev \
                   unzip wget python3-pip curl git cmake make
$ sudo pip3 install numpy==1.22.1
$ wget "https://raw.githubusercontent.com/PINTO0309/TensorflowLite-bin/main/2.9.0-rc0/download_tflite_runtime-2.9.0rc0-cp39-none-linux_aarch64.whl.sh"
$ chmod +x download_tflite_runtime-2.9.0rc0-cp39-none-linux_aarch64.whl.sh
$ ./download_tflite_runtime-2.9.0rc0-cp39-none-linux_aarch64.whl.sh
